    ...
    <section>
      ...
      <ul className={styles.listWrap}>
        <li>
          ...
          <p>WMS, Fullfilment, 중심의 물류 도메인을 가진 회사입니다. WMS와 Fullfilment, admin을 개발 및 유지보수하였습니다.</p>
          <ul className={styles.listContents}>
            ...
            <li>
              ...
              제작하여 디자인팀과 개발팀간의 아이콘 소통방식 개선 및 개발팀내 복잡한 아이콘 사용방식 개선
            </li>
            <li>
              서버 데이터 모킹을 위해 msw를 적용하고, 이를 생산적으로 사용하기
              위해 msw-gui를 개발하여 팀내 생산성 향상
            </li>
            <li>
              디자인 시스템내 정의되어있는 피그마 컴포넌트를 코드로 옮기기
              위해 피그마 devmode plugin을 활용하여 피그마 컴포넌트를 코드로
              변환하는 스크립트를 개발하여 정확한 컴포넌트를 쉽게 구현할 수 있도록 했습니다.
            </li>
            <li>
              여러 레포간에 공통적으로 사용되는 라이브러리를 관리하기 위해
              모노레포를 구성하고 github package를 이용해 배포하였으며 테스트코드와 버저닝을
              통해 안정성을 보장하였습니다. 또한 docusaurus를 통한 문서화로 팀내 개발자들이 쉽게 사용할수 있도록 하였습니다.
            </li>
            <li>
              사내 디자인 시스템이 명확하게 정의되어있지 않아 논의를 통해 이를 정의하고, shadcn ui를 기반으로 ui 컴포넌트를 제작하였습니다. 
              또한 구현된 결과물의 안정성과 공유를 위해 storybook과 playwrite를 이용한 회귀 테스트를 작성하였습니다.
            </li>
          </ul>
        </li>
      </ul>
